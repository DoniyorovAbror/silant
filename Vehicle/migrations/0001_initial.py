    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additionalOptions', models.TextField(blank=True, verbose_name='Доп. опции')),
                ...
                ('modelOfEngine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_Engine', to='Handbook.modelofengine', verbose_name='Модель двигателя')),
                ('modelOfMachine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_Machine', to='Handbook.modelofmachine', verbose_name='Модель техники')),
                ('modelOfMainAxle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_MainAxle', to='Handbook.modelofmainaxle', verbose_name='Модель ведущего моста')),
                ('modelOfSteeringAxle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_SteeringAxle', to='Handbook.modelofsteeringaxle', verbose_name='Модель управляемого моста')),
                ('modelOfTransmission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_Transmission', to='Handbook.modeloftransmission', verbose_name='Модель трансмиссии')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='machine', to='Vehicle.vehicle', verbose_name='Машина')),
                ...
                ('typeOfMaintenance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handbook_Maintenance', to='Handbook.typeofmaintenance', verbose_name='Вид ТО')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='complaints_machine', to='Vehicle.vehicle', verbose_name='Машина')),
