...
class Vehicle(models.Model):
    ...
    modelOfMachine = models.ForeignKey(ModelOfMachine, verbose_name='Модель техники', related_name='handbook_Machine', on_delete=models.CASCADE)
    modelOfEngine = models.ForeignKey(ModelOfEngine, verbose_name='Модель двигателя', related_name='handbook_Engine', on_delete=models.CASCADE)
    factoryNumberOfEngine = models.CharField(max_length=128, verbose_name='Зав. № двигателя')
    modelOfTransmission = models.ForeignKey(ModelOfTransmission, verbose_name='Модель трансмиссии', related_name='handbook_Transmission', on_delete=models.CASCADE)
    factoryNumberOfTransmission = models.CharField(max_length=128, verbose_name='Зав. № трансмиссии')
    modelOfMainAxle = models.ForeignKey(ModelOfMainAxle, verbose_name='Модель ведущего моста', related_name='handbook_MainAxle', on_delete=models.CASCADE)
    factoryNumberOfMainAxle = models.CharField(max_length=128, verbose_name='Зав. № ведущего моста')
    modelOfSteeringAxle = models.ForeignKey(ModelOfSteeringAxle, verbose_name='Модель управляемого моста', related_name='handbook_SteeringAxle', on_delete=models.CASCADE)
    ...
    serviceCompany = models.ForeignKey(User, verbose_name='Сервисная компания', related_name='serviceCompany', on_delete=models.CASCADE)
...
class Maintenance(models.Model):
    typeOfMaintenance = models.ForeignKey(TypeOfMaintenance, verbose_name='Вид ТО', related_name='handbook_Maintenance', on_delete=models.CASCADE)
    ...
    machine = models.ForeignKey(Vehicle, verbose_name='Машина', related_name='machine', on_delete=models.CASCADE)
    # serviceCompany = models.ForeignKey(User, verbose_name='Сервисная компания', related_name='serviceCompany', on_delete=models.CASCADE)
...
class Complaints(models.Model):
    ...
    machine = models.ForeignKey(Vehicle, verbose_name='Машина', related_name='complaints_machine', on_delete=models.CASCADE)
